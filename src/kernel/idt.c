 ...
 * int_num is passed from assembly
 */
void isr_handler(int int_num) {
    ...
    /* Set error color: red text on black background */
    fb_set_text_color(0x00FF0000, 0x00000000);
    ...
    fb_print(" !!!\n");
    fb_print("Exception number: ");
    fb_print_int(int_num);
    fb_print("\n");
    fb_print("System halted.\n");
